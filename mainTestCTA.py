...
S = Surface(a, b, c, Pos[0], Pos[1], Pos[2], dprim, Radius, 'Plan')
...
Pntprojection3 = Feuille3.projection(saut, F, x, y, z, delta1)[0]
Pntprojection4 = Feuille4.projection(saut, F, x, y, z, delta1)[0]
Pntprojection5 = Feuille5.projection(saut, F, x, y, z, delta1)[0]
...
ax.scatter(d, CentreH1, CentreV1, color='k')
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
